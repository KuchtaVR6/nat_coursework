...
class ParticleSwarmOptimization:
    def __init__(
        ...
        self.particle_stopped = [False for _ in range(population_size)]
    ...
    def __perform_an_iteration(self, verbose: bool):
        ...
        for particle in self.particles:
            ...
            # using the best_ever scheme, updating the global best
...
class Particle:
    def __init__(self, swarm: ParticleSwarmOptimization, label='label not set'):
        ...
        # based on the initialisation from the slides
